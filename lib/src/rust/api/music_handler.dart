...
// These functions are ignored because they are not marked as `pub`: `background_worker`, `crossfade`, `extract_metadata`, `get_position`, `new`, `pause`, `play`, `resume`, `seek`, `stop`
